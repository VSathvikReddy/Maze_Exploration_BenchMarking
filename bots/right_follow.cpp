...
class RightWallBot : public Player_base {
private:
...
public:
    RightWallBot(uint8_t tile_size, int x, int y)
    ...
    {
        // 1. Check our relative RIGHT first
...
Player_base* create_bot(uint8_t tile_size, int x, int y) {
    return new RightWallBot(tile_size, x, y);
}